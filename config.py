...
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8855444671:AAG9dtteX7SbrIacq4evR9ThjOL0SJfYGuo")
# ------------------------------------------------
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "-1003422914923"))
# -----------------------------------------------
...
# -----------------------------------------------
ADMIN_BOT_USERNAME = "Helpbyparth_bot"  # without @

THUMB_URL = os.environ.get("THUMB_URL", "https://ibb.co/9Snm7Ds")
